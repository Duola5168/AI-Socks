...
// FinMind and GitHub PAT are accessed via the built-in proxy, so from the frontend's perspective,
// they are always configured. The backend will return an error if the secret is missing.
