import { ScoredStock, TradeHistory, DebateReport, NewsSentimentReport, AIStrategyAnalysis, MarketHealth, StrategySettings, StockData } from '../types';
...
${finmindApiReference}`;
    ...
    const userPrompt = `
      ...
      **分析指令:**
      ...
      2.  **Fundamentals**: 評估其營收是否不穩、獲利能力(ROE, EPS)是否有隱憂等基本面缺陷。
